...
/**
 * Schéma de validation pour le formulaire d'édition d'opérateur
 * Règles :
...
type EditOperatorFormData = z.infer<typeof editOperatorSchema>;
...
export default function EditOperatorForm({ operatorId }: EditOperatorFormProps) {
   ...
   */
  const onSubmit = async (data: EditOperatorFormData) => {
    try {
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-2xl mx-auto">
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Modifiez les informations du compte gestionnaire
            </p>
          </div>
          <div>
            {/* Message de succès */}
