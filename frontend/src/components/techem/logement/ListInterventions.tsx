...
export default function ListInterventions({
  ...
  const handleExportInterventions = useCallback(async () => {
    await exportInterventions(pkLogement);
  }, [exportInterventions, pkLogement]);

  // Use the reusable export hook
  const { handleExport, isExporting, error: exportError, clearError: clearExportError } = useExport(handleExportInterventions);
      ...
      <div className="mb-6 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isExporting || depannages.length === 0}
